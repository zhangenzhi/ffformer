...
class BaseModel(BaseModule):
    ...
    def train_step(self, data: Union[dict, tuple, list],
        ...
        with optim_wrapper.optim_context(self):
            ...
            losses = self._run_forward(data, epoch=epoch, mode='loss')  # type: ignore
        parsed_losses, log_vars = self.parse_losses(losses)  # type: ignore
        optim_wrapper.update_params(parsed_losses)
        return log_vars

    def val_step(self, data: Union[tuple, dict, list],epoch: int) -> list:
        ...
        return self._run_forward(data, epoch=epoch, mode='predict')  # type: ignore

    def test_step(self, data: Union[dict, tuple, list],epoch: int) -> list:
    ...
    def _run_forward(self, data: Union[dict, tuple, list],
                     mode: str,
                     epoch: int) -> Union[Dict[str, torch.Tensor], list]:
        ...
        if isinstance(data, dict):
            results = self(**data, mode=mode, epoch=epoch)
