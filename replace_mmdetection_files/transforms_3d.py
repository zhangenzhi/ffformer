...
class RandomFlip3D(RandomFlip):
    ...
    def random_flip_data_3d(self,
        ...
        # Update vote_label
        if 'vote_label' in input_dict:
            if direction == 'horizontal':
                # Horizontal flip
                input_dict['vote_label'][:, 0] = -input_dict['vote_label'][:, 0]
            elif direction == 'vertical':
                # Vertical flip
                input_dict['vote_label'][:, 1] = -input_dict['vote_label'][:, 1]
...
class GlobalRotScaleTrans(BaseTransform):
    ...
    def _trans_bbox_points(self, input_dict: dict) -> None:
        ...
        if 'vote_label' in input_dict:
            input_dict['vote_label'] += trans_factor
    ...
    def _rot_bbox_points(self, input_dict: dict) -> None:
        ...
        rot_mat = self._rotation_matrix(noise_rotation)
        ...
        if 'vote_label' in input_dict:
            input_dict['vote_label'] = np.dot(input_dict['vote_label'], rot_mat.T)
