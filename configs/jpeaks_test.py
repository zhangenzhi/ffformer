"""Config for JPEAKS custom LiDAR data inference."""
_base_ = [
    'mmdet3d::_base_/default_runtime.py',
]
custom_imports = dict(imports=['oneformer3d'])

# model settings (same as trained model)
num_channels = 32
...
# dataset - will be overridden by --cfg-options for different scenes
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='forainetv2_oneformer3d_infos_jpeaks_area1.pkl',
...
# evaluator (dummy — no GT available, will error but PLY is saved first)
